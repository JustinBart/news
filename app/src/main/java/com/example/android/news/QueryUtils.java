...
public class QueryUtils {
    ...
    /**
     * Query the Guardian open platform and return a list of {@link News} objects.
     */
    ...
    private static List<News> extractFeatureFromJson(String newsJson) {
        ...
        try {
            ...
            for (int i = 0; i < news.length(); i++) {
                ...
                JSONObject currentStory = news.getJSONObject(i);
                ...
                // Extract the value for the key called "references"
                ...
                for (int j = 0; j < tags.length(); j++) {
                    JSONObject ref = tags.getJSONObject(j);
                    String refType = ref.getString("type");
                    if (refType.equals("contributor")) {
                        author = ref.getString("webTitle");
                    }
                }

                // Create a new {@link News} object
                News newsArticle = new News(title, section, type, date, author, url);

                // Add the new {@link News} to the list of newsStories.
                newsStories.add(newsArticle);
            }
            ...
            Log.e("QueryUtils", "Problem parsing the new story JSON results", e);
        }
